...
int32_t main() {
  ...
  vector<vector<ull>> transition(2, vector<ull>(2, 0)), res(2, vector<ull>(2, 0));
  transition[0][0] = 0, transition[0][1] = transition[1][0] = transition[1][1] = 1;
  res[0][0] = res[1][1] = 1;    // identity matrix
  if(n) n--;
  else{
  	cout<<0<<endl;
  	return 0;
